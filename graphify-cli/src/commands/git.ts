...
export async function executeGitOperations(
  ...
  try {
    ...
    const formattedDate = formatDateForGit(date);
...
/**
 * Format a date in the format expected by Git
 */
function formatDateForGit(date: Date): string {
  // Format: "Fri Jan 01 2021 12:00:00 GMT+0000 (Coordinated Universal Time)"
  // Or RFC 2822: "Fri, 01 Jan 2021 12:00:00 +0000"
