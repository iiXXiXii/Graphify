/**
 * Centralized configuration types for Graphify
 * This is the single source of truth for all config types
 */
...
export interface PatternPlugin {
  ...
  /**
   * Validate if the configuration is valid for this pattern
